...
def data():
    ...
    today_date=datetime.now()
    res_del1=db.opdata.delete_many({"x_coordinate":{"$lt":datetime(today_date.year,today_date.month,today_date.day)}})
    ...
    calldown = client.fetch_market_depth_by_symbol(callstrikedown)['Data'][0]
    ...
    # print(all_items[0]['x_coordinate'])
    # print(type(all_items[0]['x_coordinate']))

    # print(past)
    # if past < all_items[0]['x_coordinate']:
    #     print("true")
    # else:
    #     print("false")
    XAxis=[]
